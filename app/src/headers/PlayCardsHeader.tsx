 ...
 * technique as living-forest-duel's UseSankiCardHeader.
 */
export const PlayCardsHeader = () => {
  ...
  return <Trans i18nKey="header.play.you" components={{ end: <PlayMoveButton move={end} auto={stuck ? 10 : undefined} /> }} />
}
